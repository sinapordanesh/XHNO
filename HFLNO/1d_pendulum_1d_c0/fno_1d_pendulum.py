...
from utils.utilities3 import *  # ADDED
from utils.Adam import Adam     # ADDED
import time
import argparse             # ADDED

parser = argparse.ArgumentParser()

parser.add_argument("--case", help="The name of the experiment case.", type=str, required=True)
parser.add_argument("--data_path", help="Path to the data file.", type=str, required=True)
...
parser.add_argument("--batch_size_test", type=int, help="batch_size_test", default=1)
