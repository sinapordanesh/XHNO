...
width = 16     # uplifting dimension
layers = 4       # no of wavelet layers

sub = 2          # subsampling rate
h =   50                 #int(((101 - 1)/sub) + 1) # total grid size divided by the subsampling rate
...
x_train = reader.read_field('lognorm_a_training')
y_train = reader.read_field('lognorm_p_training')

x_test = reader.read_field('lognorm_a_validation')
y_test = reader.read_field('lognorm_p_validation')
